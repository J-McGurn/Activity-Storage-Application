...
public class Games {
    ...
    public void buttons() {
        ...
        input.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Disable main game window until entry form window is closed
    ...
    public void table() {
        ...
        String[] columnNames = { "Title", "Rating", "Platform" };

        try {
            MySQLAccess dbAccess = new MySQLAccess();
            Object[][] data = dbAccess.getTableData("games");
    ...
    class EntryForm extends JFrame {
        ...
        private JComboBox<String> ratingList, platformList;
        private JTextField titleField;
        private JLabel titleLabel, ratingLabel, platformLabel;
        ...
        public EntryForm(JFrame parentFrame) {
            ...
            String[] platform = { "XBOX", "Playstation", "PC", "Nintendo Switch" };
            platformList = new JComboBox<>(platform);
            formPanel.add(platformLabel);
            formPanel.add(platformList);
            ...
            confirm.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    if (titleField.getText().trim().isEmpty()) {
                        ...
                        String platform = (String) platformList.getSelectedItem();

                        // Call addEntry method with the data
                        if (addEntry(title, rating, platform)) {

                            // Close the entry form window
                            dispose();
                            // Enable main game window
            ...
            addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing(WindowEvent e) {
                    // Enable main game window when entry form window is closed using "X" button
                    parentFrame.setEnabled(true);
                }
            });
        ...
        private Boolean addEntry(String title, String rating, String selectedGenres) {
            MySQLAccess dbAccess = new MySQLAccess();
            boolean result = dbAccess.addGame(title, rating, selectedGenres);
            if (!result) {
                JOptionPane.showMessageDialog(this,
                        "This game title has already been added.",
                        "Error!", JOptionPane.ERROR_MESSAGE);
    ...
    class DeleteForm extends JFrame {
        ...
        private boolean deleteEntry(String title) {
            MySQLAccess dbAccess = new MySQLAccess();
            boolean result = dbAccess.deleteEntry(title, "games");
            if (!result) {
                JOptionPane.showMessageDialog(this,
                        "This game could not be deleted.",
                        "Error!", JOptionPane.ERROR_MESSAGE);
            } else {
                // Refresh the table data
                DefaultTableModel model = (DefaultTableModel) table.getModel();
